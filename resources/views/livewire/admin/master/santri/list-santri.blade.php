    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="#">Santri</a>
                </div>                                              
            </div>
        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col col-md-6">
                                    <div class="btn-group">                            
                                        ...
                                        <a href="{{ route('master.santri.import') }}" class="btn btn-primary" > Import <i class="fa fa-plus-circle"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="table-responsive">
                        <table id="tbl_santri" class="table table-bordered table-striped">
                            ...
                            <tbody>  
                                ...
                                <tr >
                                    <td>{{$row->nis}}</td>
                                    <td nowrap><a href="{{'/master/santri/profil/'.$row->nis}}">{{$row->namalengkap}}</a></td>
                                    ...
                                    <td nowrap>({{((!empty($row->tingkat->tingkat)) ? $row->tingkat->tingkat : "")}}) | {{((!empty($row->rombels[0]->rombel)) ? $row->rombels[0]->rombel : "")}}</td>
                                    <td>
                    ...
                    <div class="modal-body">
                            <div class="row form-group">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="nis" wire:model="nis" class="form-control" id="nis" placeholder="No. induk" {{(($update_mode) ? "readonly":"")}}>
                                    @error('nis') <span class="text-danger">{{ $message }}</span>@enderror
                                </div>
                                <div class="col-md-4">
                                    <label for="nisn">NISN</label>
                                    <input type="text" name="nisn" wire:model="nisn" class="form-control" id="nisn" placeholder="NISN">
